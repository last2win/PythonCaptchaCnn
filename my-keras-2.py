...
beforePath = "/content/gdrive/My Drive/my-project3/my-keras2"
beforePath = "./my-keras2"

def build(input_shape=(CAPTCHA_HEIGHT,   CAPTCHA_WIDTH, 3), num_classes=VOCAB_LENGTH*4):
    model = Sequential()
...
def build2(input_shape=(CAPTCHA_HEIGHT,   CAPTCHA_WIDTH, 1), num_classes=VOCAB_LENGTH):
    model = Sequential()
