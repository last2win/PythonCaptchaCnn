...
!python "/content/gdrive/My Drive/my-project3/other-keras.py" 2>&1 | tee  "/content/gdrive/My Drive/my-project3/keras/$(date)-other-keras.log"
...
checkpoint_path = "/content/gdrive/My Drive/my-project3/keras/cp.ckpt"
...
TensorBoardcallback = keras.callbacks.TensorBoard(
    log_dir='/content/gdrive/My Drive/my-project3/keras/logs',
...
model.save('/content/gdrive/My Drive/my-project3/keras/keras_number_model.h5')
time1 = time.time()
