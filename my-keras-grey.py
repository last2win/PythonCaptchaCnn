...
beforePath = "/content/gdrive/My Drive/my-project3/my-keras-grey"
#beforePath = "./my-keras-grey"

def build(input_shape=(CAPTCHA_HEIGHT,   CAPTCHA_WIDTH, 1), num_classes=40):
    model = Sequential()
...
def build2(input_shape=(CAPTCHA_HEIGHT,   CAPTCHA_WIDTH, 1), num_classes=10):
    model = Sequential()
