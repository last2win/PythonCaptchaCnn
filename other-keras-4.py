...
!python "/content/gdrive/My Drive/my-project3/other-keras-4.py" 2>&1 | tee  "/content/gdrive/My Drive/my-project3/keras_4/$(date).log"
...
checkpoint_path = "/content/gdrive/My Drive/my-project3/keras_4/cp.ckpt"
...
TensorBoardcallback = keras.callbacks.TensorBoard(
    log_dir='/content/gdrive/My Drive/my-project3/keras_4/logs',
...
model.save(
    '/content/gdrive/My Drive/my-project3/keras_4/keras_number_ascii_model.h5')
time1 = time.time()
