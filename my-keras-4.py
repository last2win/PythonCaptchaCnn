...
beforePath = "/content/gdrive/My Drive/my-project3/my-keras4"
beforePath = "./my-keras4"
...
def create_model():
    model = keras.models.Sequential([
        ...
        keras.layers.Dense(VOCAB_LENGTH, activation='softmax')
    ])
...
if __name__ == '__main__':
    ...
    for i in range(0,4):
        ...
        j=str(i)
        beforePath=beforePath+"/"+"createModel2"+"/"+j
        loadData.__NOW__=i
