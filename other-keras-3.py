...
!cat "/content/gdrive/My Drive/my-project3/other-keras-3.py"

!python "/content/gdrive/My Drive/my-project3/other-keras-3.py" 2>&1 | tee  "/content/gdrive/My Drive/my-project3/keras_3/$(date)-other-keras.log"
...
checkpoint_path = "/content/gdrive/My Drive/my-project3/keras_3/cp.ckpt"
...
TensorBoardcallback = keras.callbacks.TensorBoard(
    log_dir='/content/gdrive/My Drive/my-project3/keras_3/logs',
...
model.fit_generator(gen(),
                    ...
                    steps_per_epoch=51200 // 20,  # 一轮多少个
                    nb_epoch=5,
...
model.save('/content/gdrive/My Drive/my-project3/keras_3/keras_number_ascii_model.h5')
time1 = time.time()
